...
<body>
    ...
    <?php
    // Jika file berhasil diunggah dan disimpan, redirect ke halaman lain atau tampilkan hasilnya di sini
    // Contoh redirect ke halaman lain setelah 3 detik
    if (!empty($message) && strpos($message, "berhasil") !== false) {
        echo "<script>setTimeout(function() { window.location.href = 'halaman_hasil_upload.php'; }, 3000);</script>";
    }
    ?>
</body>
</html>
